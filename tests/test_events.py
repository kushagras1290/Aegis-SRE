...
def valid(): return dict(event_id='evt_123456',event_type='telemetry.metric.v1',schema_version=1,occurred_at=datetime.now(timezone.utc),organization_id='org',environment='production',source='otel')
